...
Комплексное число.
Конструкторы: конструктор по умолчанию, конструктор копирования, конструктор вещественного число, конструктор комплексного 
числа.
Функциональность: умножение вещественного числа на комплексное число, сложение двух комплексных чисел, умножение двух 
комплексных чисел, длина комплексного числа, вывод на экран. */
#include <iostream>
#include "header.hpp"
